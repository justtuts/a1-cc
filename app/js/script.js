...
function openMobileMenu() {
	...
	bodyScrollLock.disableBodyScroll(menuTopNav); //disables scrolling when menu is open
...
function closeMobileMenu() {
	...
	bodyScrollLock.enableBodyScroll(menuTopNav); // re-enables scrolling when menu is closed
